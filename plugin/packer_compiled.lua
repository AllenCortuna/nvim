...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'cinnamon.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'Comment.nvim', 'nvim-web-devicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'cinnamon.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'Comment.nvim', 'nvim-web-devicons'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
