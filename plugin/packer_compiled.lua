...
_G.packer_plugins = {
  ...
  ["todo.nvim"] = {
    ...
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/todo.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-web-devicons', 'gitsigns.nvim', 'nvim-treesitter', 'cinnamon.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'Comment.nvim', 'nvim-web-devicons', 'gitsigns.nvim', 'nvim-treesitter', 'cinnamon.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
