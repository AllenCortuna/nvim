...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'todo.nvim', 'cinnamon.nvim', 'Comment.nvim', 'nvim-web-devicons', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'todo.nvim', 'cinnamon.nvim', 'Comment.nvim', 'nvim-web-devicons', 'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
