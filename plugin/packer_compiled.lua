...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'cinnamon.nvim', 'Comment.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'nvim-web-devicons'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'indent-blankline.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-ts-autotag', 'nvim-autopairs', 'friendly-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'cinnamon.nvim', 'Comment.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'nvim-web-devicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
