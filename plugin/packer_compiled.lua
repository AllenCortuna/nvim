...
_G.packer_plugins = {
  ...
  ["indent-blankline.nvim"] = {
    config = { "\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19conf.blankline\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["material.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/material.nvim",
...
try_loadstring("\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19conf.rose-pine\frequire\0", "config", "rose-pine")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-lspconfig', 'gitsigns.nvim', 'nvim-web-devicons', 'mason.nvim', 'nvim-treesitter', 'cinnamon.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'Comment.nvim', 'nvim-lspconfig', 'gitsigns.nvim', 'nvim-web-devicons', 'mason.nvim', 'nvim-treesitter', 'cinnamon.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
